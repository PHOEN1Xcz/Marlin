...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LED_CONTROL_MENU
    ...
    //#define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option
      ...
      #define LED_USER_PRESET_RED        230  // User defined RED value
      #define LED_USER_PRESET_GREEN      230  // User defined GREEN value
      #define LED_USER_PRESET_BLUE       230  // User defined BLUE value
      #define LED_USER_PRESET_WHITE      230  // User defined WHITE value
