...
#define STRING_CONFIG_H_AUTHOR "(BLV MGN Cube FORGE by PHOEN1X)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FORGE"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi  36.18
  #define DEFAULT_bedKd 764.69
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 400, 100 }
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 35, 70 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 5, 60, 0 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 45, 12, 45, 12 } // (mm) Left, Front, Right, Back insets
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_TYPE   NEO_RGBW // NEO_GRBW / NEO_GRB - four/three channel driver type (defined in Adafruit_NeoPixel.h)
  #define NEOPIXEL_PIN     P1_24   // LED driving pin (4)
